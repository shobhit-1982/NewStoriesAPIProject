  ...
  public class StoriesServiceTest
  {
    public class TheGetALLStoriesList
    {
            ...
            public async Task Should_Return_Get_All_Stories_Data_From_ThirdParty_API()
            {
                ...
                //When
                var result = (await sut.GetTopAllStories(new PagingParameters() { PageNumber =1,PageSize =1})).Data;
                //Then
    ...
    public class ThrGetSearchStories
    {
            ...
            public async Task Should_Return_Get_searched_Stories_Data_If_Param_Provided(string searchStoryTitle)
            {
                ...
                StoriesService sut = new StoriesServiceFixture();
                //When
                var result = (await sut.GetSearchStories(searchStoryTitle)).Data;
                //Then
                result.Should().HaveCount(1);
            }
            ...
            /// <summary>
            /// Should the return  searched Stories count 0 If Parameter not Provided & founded.
            /// </summary>
            [Theory]
            [InlineData("")]
            ...
            /// <summary>
            /// Should the return  searched Stories count 0 If Parameter Provided but title not fount
            /// </summary>
            [Theory]
            [InlineData("wew23232")]
